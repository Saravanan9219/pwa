...
var _adder = __webpack_require__(27);

var _register_service_worker = __webpack_require__(33);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom.default.render(_react.default.createElement(_adder.Adder, null), document.getElementById('root'));

(0, _register_service_worker.registerServiceWorker)();
...
function (_React$Component) {
  ...
  function Adder(props) {
    ...
    _this = _possibleConstructorReturn(this, (Adder.__proto__ || Object.getPrototypeOf(Adder)).call(this, props));
    _this.state = {
      a: 0,
      b: 0,
      result: 0
  ...
  _createClass(Adder, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement("form", null, _react.default.createElement("label", null, "A"), _react.default.createElement("input", {
        label: "A",
        name: "a",
        type: "number",
        value: this.state.a,
      ...
      }), _react.default.createElement("label", null, "B"), _react.default.createElement("input", {
        label: "B",
        name: "b",
        type: "number",
        value: this.state.b,
      ...
      })), _react.default.createElement("div", null, this.state.result));
    }
  }]);
...
if(false) {
	module.hot.accept("!!./node_modules/css-loader/index.js!./adder.css", function() {
		var newContent = require("!!./node_modules/css-loader/index.js!./adder.css");
